...
HD_PWD='C:/Xilinx/vivado_projects/test_model5/test_model5.runs/design_1_crrs_filter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_crrs_filter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_crrs_filter_0_0.tcl
